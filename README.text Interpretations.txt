...
Our model has a Precision of 0.70 for Class 1. This means when our model flags risk, it is right 70% of the time. Combined with the high recall (95%), our model is basically saying "No" to almost everyone just to be safe. We have 84 Bad examples and only 40 Good examples in our test set. Our model saw way more "Bad" loans, so it learned that guessing "Bad" is usually the safest bet. This is called Class Imbalance.
