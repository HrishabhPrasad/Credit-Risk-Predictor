...
db_config = {
    'user': 'root',
    'password': 'Stephen1403!',  # <--- UPDATE THIS
    'host': 'localhost',
    'database': 'Credit_Risk_Project'
}
...
# 3. Handle Missing Values (Banks don't like empty cells)
...
# ==========================================
# STEP 2: SQL QUERY (THE ANALYST ROLE)
# ==========================================
...
# ==========================================
# STEP 3: MODELING (THE DATA SCIENTIST ROLE)
# ==========================================
